...
This is a link to the Bill of materials. I am also willing to sell a pre-assembled model for 250 USD as I understand that this is slightly more expansive then the entrey level printers that other companies make however this is a heigh quality design that is entierly open source and with the detachable head other activitys are cabible of being done with just the one perchace. 
      <h1>Why would you choose this over anyother Printer?</h1>
      <p>Unlike other pritners that have propriatery software that and expansive fixes this is fully open source and easy to modify. Furthermore unlike other printers that take up a significant amount of space for it's use the footprint of the Pi-Printer is relitivly small and can be mounted on the side of a wall, or even upside down, so long as there is adiquite room for the print bay. Furthermore there are other functionallities with this device. since the head is fully swapable you can change it into basically anything you can image however the first fully supported heads will be a rotary (Dremmel) Tool, a 2D printer with refillable ink, a fax machine, a camrea, a lamp, and a hand. These are just some of the reasons to go with the cheeper, superior, Pi-Printer!</p>
